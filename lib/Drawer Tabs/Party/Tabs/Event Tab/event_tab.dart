...
class _EventTabState extends State<EventTab> {
  ...
  List<EventModel> _getFilteredEvents(
    ...
    switch (selectedTab) {
      ...
      case 2:
        return events
            .where((event) => event.kind.toUpperCase() == "PRIVATE")
            .toList();
      ...
      // ----------------------------------------------------------
      case 3:
        return events.where(_hasEventEnded).toList();
    ...
    return BlocConsumer<EventsBloc, EventTabState>(
      listener: (context, state) {
        if (state.isSuccessInJoining) {
          ...
          context.read<EventsBloc>().add(ClearJoinMessageEvent());
        }
        ...
        if (state.isEventDeleted) {
          ...
          context.read<EventsBloc>().add(ClearDeleteMessageEvent());
        }
      ...
      builder: (context, state) {
        ...
        // MAIN EVENT UI
        // --------------------------------------------------------
        final List<EventModel> filteredEvents = _getFilteredEvents(
          state.events,
          state.selectedTab,
        );
        return Container(
            ...
            children: [
              ...
              filteredEvents.isEmpty
                  ...
                  : ListView.separated(
                      ...
                      // ------------------------------------------------
                      itemCount:
                          filteredEvents.length + (state.isLoadingMore ? 1 : 0),
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final fromDate = eventData.eventFrom
                            .toString()
                            .substring(0, 10);
                              ...
                              ? Stack(
                                  ...
                                  children: [
                                    ...
                                    Positioned(
                                      ...
                                      // Keep the card at the same relative position
                                      // on every device.
                                      top:  w * 0.55,
